...
<header> 
    ...
    <section class="conteudo-principal">
      <div class="conteudo-principal-escrito">
        ...
        <p class="conteudo-principal-escrito-subtitulo">Localizada no caminho da Boa Esperança, assim como presente em uma placa sinalizando o local, a escada que leva até a cascata foi inaugurada em 2013. Facíl acesso e descida segura. <br>Caminho das Pipas - Boa Esperança, Rolante - RS, 95690-000<br>
        <br>Aberto 24 horas</br>
		    <br>Telefone: (51) 3547-1188</br>
		    <br>nenhum custo para visitação</br></p>
